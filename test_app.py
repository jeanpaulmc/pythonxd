...
class Tests(unittest.TestCase):
    ...
    def test_total_vacunados_1(self):
        ...
        self.assertEqual(self.centro_vacunacion.total_vacunados_1,
                         370000, "Total vacunados 2")
    ...
    def test_vacunados_porcentaje_1(self):
        ...
        self.assertEqual(round(porcentaje_vacunados, 2),
                         1.61, "Porcentaje de vacunados 1")
    ...
    def test_total_vacunados_2(self):
        ...
        self.assertEqual(self.centro_vacunacion.total_vacunados_2,
                         20000, "Total vacunados 2")

    def test_vacunados_porcentaje_2(self):
        self.assertTrue(self.centro_vacunacion.total_vacunados_1 >=
                        self.centro_vacunacion.total_vacunados_2)
        porcentaje_vacunados = (
            self.centro_vacunacion.total_vacunados_2/self.centro_vacunacion.total_personas)*100
        self.assertEqual(round(porcentaje_vacunados, 2),
                         0.09, "Porcentaje de vacunados 2")

    def test_vacunados_senior(self):
        self.assertEqual(self.centro_vacunacion.porc_personas(15), -1)
        self.assertEqual(
            round(self.centro_vacunacion.porc_personas(20), 2), 0.08)
        self.assertEqual(
            round(self.centro_vacunacion.porc_personas(82), 2), 0.77)
        self.assertEqual(
            round(self.centro_vacunacion.porc_personas(75), 2), 0.24)
        self.assertEqual(
            round(self.centro_vacunacion.porc_personas(65), 2), 0.23)
        self.assertEqual(
            round(self.centro_vacunacion.porc_personas(54), 2), 0.15)
        self.assertEqual(
            round(self.centro_vacunacion.porc_personas(43), 2), 0.12)
        self.assertEqual(
            round(self.centro_vacunacion.porc_personas(33), 2), 0.10)
